...
import { AnyVal, Callback, HashFunction, Predicate, RawObject } from "./types";
/**
...
export declare type AccumulatorOperator = (collection: RawObject[], expr: AnyVal, options?: Options) => AnyVal;
